...
const products = {
  "ofertas-familiares": [
    ...
    { name: "Oferton mas fideo", description: "Pollo entero, papas fritas, fideos al pesto, ensalada y bebidas 1.5lt.", price: 25500, image: "img/oferton mas fideo.png" },
    { name: "Oferton con fideo al pesto pura papa", description: "Pollo entero, papas fritas, fideos al pesto, extra papa frita y bebida 1.5lt.", price: 25500, image: "" },
    ...
    { name: "Oferton con fideo", description: "Pollo entero, papas fritas, fideos al pesto y bebidas 1.5lt", price: 24500, image:"img/oferton con fideo.png" },
    ...
    { name: "Oferton solo ensalada", description: "Pollo entero, ensalada y bebida 1.5lt.", price: 23500, image: "" },
    { name: "Mega Familiar", description: "Pollo entero, papas fritas, ensalada y bebidas 1.5lt", price: 22500, image:"img/oferton familiar.png" }
  ],
  "ofertas-dos": [
    ...
    { name: "1/2 pollo solo ensalada", description: "Medio pollo con ensalada personal", price: 15600, image: "" }
  ],
  "ofertas-personales": [
    ...
    { name: "Fideo al pesto con 1/4 de pollo", description: "1/4 pollo, fideos al pesto", price: 8400, image: "img/personal pesto con pollo.png" },
    { name: "Chaufa brasa con ensalada", description: "1/4 pollo, arroz chaufa y ensalada personal", price: 9500, image: "" },
    { name: "Chaufa brasa con papas fritas", description: "1/4 pollo, papas fritas personal, arroz chaufa", price: 9500, image: "img/chaufa brasa con papas fritas.png" },
    { name: "1/4 de pollo con fideo y papa", description: "1/4 pollo, papas fritas, fideos al pesto", price: 9600, image: "img/personal con papa y fideo 01.png" },
    { name: "1/4 de pollo solo ensalada", description: "1/4 pollo con ensalada personal", price: 8400, image: "" }
  ],
  "platos-extras": [
    { name: "Lomo saltado de carnecon chaufa", description: "", price: 12500, image: "img/lomo saltado con arroz chaufa.png" },
    ...
    { name: "Tallarin saltado", description: "", price: 12000, image: "img/tallarin saltado de carne 01.png" },
  ...
  "descartables": [
    ...
    { name: "Tenedor descartable", description: "Tenedor y cuchillo plástico descartable.", price: 200, image: "img/servicio descartable.png" },
    { name: "Bolsa ecológica", description: "Bolsa ecológica (unidad).", price: 200, image: "img/bolsa ecologica.png" },
    { name: "Bolsa chica", description: "Bolsa chica descartable (unidad).", price: 200, image: "" },
    { name: "Vaso descartable", description: "vaso de 10 oz (unidad).", price: 50, image: "img/vaso.png" }
  ]
