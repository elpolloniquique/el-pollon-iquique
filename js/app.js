...
// };
>>>>>>> 8b8bab77391ae7836ecc5c2ccd6b8a5476503d41
...
function buildPortfolioCard(p, catKey) {
  ...
  const imgBlock = img
    ? `<img src="${escHtml(img)}" alt="${name}" class="portfolio-card__img" loading="lazy"
  ...
  return `
    <article class="portfolio-card">
      <div class="portfolio-card__media">
        ${imgBlock}
        <div class="portfolio-card__fallback${img ? '' : ' is-visible'}">🍗</div>
      </div>
